...
def drawStateCard(app, canvas):
    ...
    if influence == 0:
        ...
        infColor = 'red'
    canvas.create_text((app.width/2) - 60, 150, text=f'Current Influence:', font=('Arial 25 bold'))
    canvas.create_text((app.width/2) + 60, 150, text=f'{influence}', font=('Arial 25 bold'), fill=infColor)
